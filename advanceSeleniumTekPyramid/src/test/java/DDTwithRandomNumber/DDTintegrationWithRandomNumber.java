...
public class DDTintegrationWithRandomNumber{
	...
	public static void main(String[] args) throws Throwable {
		...
		//working with common data with cross browser testing
	...
	System.out.println("fix your browser instance");
		...
		//generate random number for organization creation
		...
		String orgData = wb.getSheet("Organixation").getRow(1).getCell(2).toString()+randomInt;
